        ...
        if (window.ga) {
          ...
          for (var idx = 1; idx <= 20; idx++) {
            if (properties['dimension' + idx.toString()]) {
              eventOptions['dimension' + idx.toString()] = properties[
                'dimension' + idx.toString()];
            }
            if (properties['metric' + idx.toString()]) {
              eventOptions['metric' + idx.toString()] = properties[
                'metric' + idx.toString()];
            }
          }
          ...
          if (properties.timing) {
            ...
            eventOptions['hitType'] = 'timing';
            eventOptions['timingCategory'] = eventOptions.eventCategory;
            eventOptions['timingVar'] = eventOptions.eventAction;
          ...
          _gaq.push(['_trackEvent', properties.category, action,
            properties.label, properties.value, properties.noninteraction
          ]);
        }
